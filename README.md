...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-3%2C187%2B%20passing-brightgreen" alt="Tests">
...
| Command | Description |
|---|---|
| `npm test` | Unit tests (2,283 tests) |
...
| `npm run test:security` | Security tests (82 tests) |
...
| `npm run test:regression` | Regression tests (59 tests) |
...
| `npm run test:all` | All tests (~3,048 tests; excludes security/boundary) |
