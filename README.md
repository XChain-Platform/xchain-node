...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-3%2C043%2B%20passing-brightgreen" alt="Tests">
...
| `npm run test:security` | Security tests (81 tests) |
...
| `npm run test:all` | All tests (~2,905 tests; excludes security/boundary) |
