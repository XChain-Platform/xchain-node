...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/tests-3%2C175%2B%20passing-brightgreen" alt="Tests">
...
| Command | Description |
|---|---|
| `npm test` | Unit tests (2,271 tests) |
...
| `npm run test:all` | All tests (~3,036 tests; excludes security/boundary) |
