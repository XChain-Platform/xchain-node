 ...
 *
 * Usage:
 *   node test/benchmarks/helpers/harness.js                    # run all scenarios
 *   node test/benchmarks/helpers/harness.js --scenario NAME    # run one scenario
 *   node test/benchmarks/helpers/harness.js --list             # list available scenarios
 *   node test/benchmarks/helpers/harness.js --compare          # compare against baseline
 *   node test/benchmarks/helpers/harness.js --save-baseline    # save results as new baseline
 *   node test/benchmarks/helpers/harness.js --json             # output raw JSON
 *   node test/benchmarks/helpers/harness.js --quick            # reduced iterations
 */
...
Usage: node test/benchmarks/helpers/harness.js [options]
