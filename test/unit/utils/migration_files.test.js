...
describe('migration_files', () => {
    ...
    describe('migrationsDirOf', () => {
        it('reads the moved home when the tree carries it', () => {
            write('src/db/sql/migrations/2026-05-30/2026-05-30-a.sql', AUTO)
            write('src/sql/migrations/2026-05-30-a.sql', AUTO)
    ...
    describe('migrationFiles', () => {
        it('lists a flat directory by basename, .sql only', () => {
            write('m/2026-07-02-b.sql', AUTO)
            write('m/2026-07-01-a.sql', AUTO)
            write('m/notes.txt', AUTO)
        ...
        it('orders bucketed files by BASENAME, not by the path a bucket gives them', () => {
            ...
            write('m/z-bucket/2026-01-01-first.sql', AUTO)
            write('m/a-bucket/2026-02-01-second.sql', AUTO)
    ...
    describe('the guard over a bucketed tree', () => {
        it('finds a deploy-precondition migration inside a bucket', () => {
            write('src/db/sql/migrations/2026-07-26/2026-07-30-gated.sql', TAGGED)
            write('src/db/sql/migrations/2026-05-30/2026-05-30-plain.sql', AUTO)
        ...
        it('names pending manual migrations by basename across buckets', () => {
            write('src/db/sql/migrations/2026-07-26/2026-07-30-gated.sql', TAGGED)
            write('src/db/sql/migrations/2026-05-30/2026-05-31-other.sql', TAGGED)
