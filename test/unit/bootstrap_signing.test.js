...
function loadServiceWithRealFs() {
    return proxyquire('../../src/services/bootstrap_service', {
        '../state': { db: {} },
        './config_service':   { getDefaultConfig: sinon.stub(), getModuleDatabaseName: sinon.stub() },
        './docker_service':   { stopContainer: sinon.stub(), startContainer: sinon.stub() },
        './database_service': { getDatabaseContainerId: sinon.stub(), ensureDatabasePool: sinon.stub() }
    })
}
